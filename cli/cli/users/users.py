...
def create(
    ...
    email: str = typer.Option("", "--email", "-e", prompt=True, callback=email_validator, help="Email of the user")
):
...
def update(
    ...
    email: str = typer.Option(None, "--email", "-e", callback=email_validator, help="Email of the user")
):
    updates = {}
    if age:
        updates["age"] = age
