...
def create(
    ctx: typer.Context,
    title: str = typer.Option("", "--title", "-t", prompt=True, help="Title of the game"),
...
def update(
    ...
    age_rating: int = typer.Option(None, "--age-rating", help="New age rating of the game"), 
    description: str = typer.Option(None, "--description", "-d", help="New description of the game"),
    publisher: str = typer.Option(None, "--publisher", "-p", help="New publisher of the game"),
...
def list(
    ...
    age_rating: int = typer.Option(None, "--age-rating", help="List games by age ratings"), 
):
    filters = {}
    if age_rating: 
